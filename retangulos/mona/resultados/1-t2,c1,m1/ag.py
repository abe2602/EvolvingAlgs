...
IMG_NAME = "retangulos/mona/insta.jpg"
...
def crossover(pai, mae, POLY_NUM):
	...
	#	gene.rgba['r'] = (pai.genes[i].rgba['r'] + mae.genes[i].rgba['r']) / 2
	#	gene.rgba['g'] = (pai.genes[i].rgba['g'] + mae.genes[i].rgba['g']) / 2
	#	gene.rgba['b'] = (pai.genes[i].rgba['b'] + mae.genes[i].rgba['b']) / 2
